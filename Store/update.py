...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.master = master
        self.heading = Label(master, text="Atualizar a Base de Dados", font=('arial 40 bold'), fg='steelblue')
        ...
        self.btn_search=Button(master, text="Procurar", width=15,height=2, bg='orange', command=self.search)
    ...
    def update(self, *args, **kwargs):
        ...
        conn.commit()
        tkinter.messagebox.showinfo("Success", "Base de dados Atualizada com Sucesso.")
...
root.title("Atualizar a Base de Dados")
root.mainloop()
